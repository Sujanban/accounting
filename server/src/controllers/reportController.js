...
module.exports = {
  ...
  getVatSalesRegister: handler("getVatSalesRegister", "VAT sales register fetched successfully."),
  getVatPurchaseRegister: handler("getVatPurchaseRegister", "VAT purchase register fetched successfully."),
