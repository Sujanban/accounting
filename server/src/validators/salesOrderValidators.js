...
function validateSalesOrder(body) {
  ...
  if (!body.orderDate || typeof body.orderDate !== "string" || Number.isNaN(new Date(body.orderDate).getTime())) errors.push({ field: "orderDate", message: "A valid order date is required." });
