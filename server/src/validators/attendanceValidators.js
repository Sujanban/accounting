...
function validateAttendanceVoucher(body) {
  ...
  if (typeof body.attendanceDate !== "string" || Number.isNaN(new Date(body.attendanceDate).getTime())) errors.push({ field: "attendanceDate", message: "A valid attendance date is required." });
