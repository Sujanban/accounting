...
applySoftDeleteFields(warehouseSchema); applyAuditFields(warehouseSchema);
warehouseSchema.index({ companyId: 1, warehouseCode: 1 }, { unique: true });
warehouseSchema.index({ companyId: 1, branchId: 1, isDefault: 1 }, { unique: true, partialFilterExpression: { isDefault: true } });
