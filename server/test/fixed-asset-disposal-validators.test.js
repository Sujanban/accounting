...
test("accepts a controlled fixed-asset disposal draft", () => {
  assert.deepEqual(validateDisposalDraft({ transactionDate: "2083-04-14", proceeds: 500, accumulatedDepreciation: 300, assetCostLedgerId: ledgerIds[0], accumulatedDepreciationLedgerId: ledgerIds[1], proceedsLedgerId: ledgerIds[2], gainLossLedgerId: ledgerIds[3] }), []);
});
