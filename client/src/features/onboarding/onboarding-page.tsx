      ...
      <div className="onboarding-container py-8">
        ...
        <Card size="4">
          ...
          {step === 2 ? <form onSubmit={submitFiscalYear}><Flex direction="column" gap="4">
            ...
            {error ? <ErrorMessage message={error} /> : null}<Flex justify="between"><Button type="button" variant="soft" onClick={() => setStep(1)}>Back</Button><Button type="submit" size="3" loading={companyMutation.isPending}>Create company</Button></Flex>
          </Flex></form> : null}
